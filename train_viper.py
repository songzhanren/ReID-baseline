...
parser.add_argument('--name',default='ft_ResNet50_VIPeR_1', type=str, help='output model name')
parser.add_argument('--data_dir',default='/media/data2/songzr/mydata/VIPeR/pytorch_new',type=str, help='training dir path')
